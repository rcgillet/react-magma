  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVAlbumIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVAlbumIcon-path-1',
            },
          ],
        },
      ],
