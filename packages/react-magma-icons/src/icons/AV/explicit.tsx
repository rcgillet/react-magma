  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVExplicitIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVExplicitIcon-path-1',
            },
          ],
        },
      ],
