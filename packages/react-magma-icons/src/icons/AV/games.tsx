  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVGamesIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVGamesIcon-path-1',
            },
          ],
        },
      ],
...
export const AVGamesIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
