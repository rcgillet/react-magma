  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVMicOffIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVMicOffIcon-path-1',
            },
          ],
        },
      ],
