  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVPlaylistPlayIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVPlaylistPlayIcon-path-1',
            },
          ],
        },
      ],
