  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVQueueMusicIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVQueueMusicIcon-path-1',
            },
          ],
        },
      ],
