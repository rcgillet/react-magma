  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVShuffleIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVShuffleIcon-path-1',
            },
          ],
        },
      ],
