  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVVolumeMuteIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVVolumeMuteIcon-path-1',
            },
          ],
        },
      ],
