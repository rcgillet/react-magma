  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'AVVolumeUpIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#AVVolumeUpIcon-path-1',
            },
          ],
        },
      ],
