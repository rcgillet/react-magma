  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsAccessibilityNewIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsAccessibilityNewIcon-path-1',
            },
          ],
        },
      ],
