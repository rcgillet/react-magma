  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsAssignmentIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsAssignmentIcon-path-1',
            },
          ],
        },
      ],
...
export const ActionsAssignmentIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
