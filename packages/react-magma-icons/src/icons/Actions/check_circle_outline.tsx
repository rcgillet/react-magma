  ...
  paths: [
    {
      ...
      id: 'ActionsCheckCircleOutlineIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsCheckCircleOutlineIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsCheckCircleOutlineIcon-path-1',
            },
          ],
        },
      ],
