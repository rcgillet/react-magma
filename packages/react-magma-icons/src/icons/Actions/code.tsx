  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsCodeIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsCodeIcon-path-1',
            },
          ],
        },
      ],
