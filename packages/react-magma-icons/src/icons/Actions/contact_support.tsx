  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsContactSupportIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsContactSupportIcon-path-1',
            },
          ],
        },
      ],
