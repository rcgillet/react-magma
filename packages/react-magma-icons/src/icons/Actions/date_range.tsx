  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsDateRangeIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsDateRangeIcon-path-1',
            },
          ],
        },
      ],
