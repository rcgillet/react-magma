  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsDescriptionIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsDescriptionIcon-path-1',
            },
          ],
        },
      ],
