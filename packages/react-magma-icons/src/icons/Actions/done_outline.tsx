  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsDoneOutlineIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsDoneOutlineIcon-path-1',
            },
          ],
        },
      ],
