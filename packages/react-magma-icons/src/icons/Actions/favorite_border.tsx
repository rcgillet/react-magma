  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsFavoriteBorderIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsFavoriteBorderIcon-path-1',
            },
          ],
        },
      ],
