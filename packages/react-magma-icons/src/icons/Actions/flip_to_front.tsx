  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsFlipToFrontIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsFlipToFrontIcon-path-1',
            },
          ],
        },
      ],
