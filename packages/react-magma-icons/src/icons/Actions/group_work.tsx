  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsGroupWorkIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsGroupWorkIcon-path-1',
            },
          ],
        },
      ],
