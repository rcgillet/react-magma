  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsHourglassFullIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsHourglassFullIcon-path-1',
            },
          ],
        },
      ],
