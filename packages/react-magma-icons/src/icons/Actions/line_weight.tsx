  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsLineWeightIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsLineWeightIcon-path-1',
            },
          ],
        },
      ],
