  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsOfflineBoltIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsOfflineBoltIcon-path-1',
            },
          ],
        },
      ],
