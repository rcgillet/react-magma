  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsOpenInNewIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsOpenInNewIcon-path-1',
            },
          ],
        },
      ],
...
export const ActionsOpenInNewIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
