  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsOutletIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsOutletIcon-path-1',
            },
          ],
        },
      ],
