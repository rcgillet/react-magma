  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsPageviewIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsPageviewIcon-path-1',
            },
          ],
        },
      ],
