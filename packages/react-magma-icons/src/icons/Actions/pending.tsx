  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsPendingIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsPendingIcon-path-1',
            },
          ],
        },
      ],
