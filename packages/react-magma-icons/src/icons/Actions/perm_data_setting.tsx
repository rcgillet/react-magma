  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsPermDataSettingIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsPermDataSettingIcon-path-1',
            },
          ],
        },
      ],
...
export const ActionsPermDataSettingIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
