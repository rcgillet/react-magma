  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsPlayForWorkIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsPlayForWorkIcon-path-1',
            },
          ],
        },
      ],
