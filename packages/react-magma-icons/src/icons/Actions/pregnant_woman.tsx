  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsPregnantWomanIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsPregnantWomanIcon-path-1',
            },
          ],
        },
      ],
