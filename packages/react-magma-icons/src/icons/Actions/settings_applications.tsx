  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsSettingsApplicationsIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsSettingsApplicationsIcon-path-1',
            },
          ],
        },
      ],
