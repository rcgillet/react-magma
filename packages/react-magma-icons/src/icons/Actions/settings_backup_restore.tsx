  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsSettingsBackupRestoreIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsSettingsBackupRestoreIcon-path-1',
            },
          ],
        },
      ],
