  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsSettingsEthernetIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsSettingsEthernetIcon-path-1',
            },
          ],
        },
      ],
