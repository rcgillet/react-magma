  ...
  paths: [
    {
      ...
      id: 'ActionsSettingsInputCompositeIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsSettingsInputCompositeIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsSettingsInputCompositeIcon-path-1',
            },
          ],
        },
      ],
...
export const ActionsSettingsInputCompositeIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
