  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsSettingsPhoneIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsSettingsPhoneIcon-path-1',
            },
          ],
        },
      ],
...
export const ActionsSettingsPhoneIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
