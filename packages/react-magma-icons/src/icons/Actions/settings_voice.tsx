  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsSettingsVoiceIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsSettingsVoiceIcon-path-1',
            },
          ],
        },
      ],
