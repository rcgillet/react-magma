  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsShoppingBagIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsShoppingBagIcon-path-1',
            },
          ],
        },
      ],
