  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsTabIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsTabIcon-path-1',
            },
          ],
        },
      ],
