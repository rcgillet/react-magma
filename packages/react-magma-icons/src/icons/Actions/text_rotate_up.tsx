  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsTextRotateUpIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsTextRotateUpIcon-path-1',
            },
          ],
        },
      ],
