  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsTextRotationAngleupIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsTextRotationAngleupIcon-path-1',
            },
          ],
        },
      ],
