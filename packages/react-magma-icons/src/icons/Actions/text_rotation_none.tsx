  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsTextRotationNoneIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsTextRotationNoneIcon-path-1',
            },
          ],
        },
      ],
