  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsThumbUpIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsThumbUpIcon-path-1',
            },
          ],
        },
      ],
