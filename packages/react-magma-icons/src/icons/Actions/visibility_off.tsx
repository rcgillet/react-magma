  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ActionsVisibilityOffIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ActionsVisibilityOffIcon-path-1',
            },
          ],
        },
      ],
