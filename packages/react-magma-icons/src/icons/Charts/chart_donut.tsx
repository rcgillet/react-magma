  ...
  paths: [
    {
      ...
      id: 'ChartsChartDonutIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'ChartsChartDonutIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ChartsChartDonutIcon-path-1',
            },
          ],
        },
      ],
...
export const ChartsChartDonutIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
