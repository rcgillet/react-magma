  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ChartsChartLineIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ChartsChartLineIcon-path-1',
            },
          ],
        },
      ],
...
export const ChartsChartLineIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
