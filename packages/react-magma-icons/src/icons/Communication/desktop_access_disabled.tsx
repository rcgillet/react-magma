  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationDesktopAccessDisabledIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationDesktopAccessDisabledIcon-path-1',
            },
          ],
        },
      ],
