  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationMarkEmailReadIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationMarkEmailReadIcon-path-1',
            },
          ],
        },
      ],
