  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationMarkEmailUnreadIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationMarkEmailUnreadIcon-path-1',
            },
          ],
        },
      ],
