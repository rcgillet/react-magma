  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationMobileScreenShareIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationMobileScreenShareIcon-path-1',
            },
          ],
        },
      ],
