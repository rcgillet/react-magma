  ...
  paths: [
    {
      ...
      id: 'CommunicationPausePresentationIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationPausePresentationIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationPausePresentationIcon-path-1',
            },
          ],
        },
      ],
