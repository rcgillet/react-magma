  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationPersonSearchIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationPersonSearchIcon-path-1',
            },
          ],
        },
      ],
