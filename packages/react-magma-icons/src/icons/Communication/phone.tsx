  ...
  paths: [
    {
      ...
      id: 'CommunicationPhoneIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationPhoneIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationPhoneIcon-path-1',
            },
          ],
        },
      ],
...
export const CommunicationPhoneIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
