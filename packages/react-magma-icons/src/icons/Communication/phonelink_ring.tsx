  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationPhonelinkRingIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationPhonelinkRingIcon-path-1',
            },
          ],
        },
      ],
