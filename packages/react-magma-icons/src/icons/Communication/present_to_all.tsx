  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CommunicationPresentToAllIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CommunicationPresentToAllIcon-path-1',
            },
          ],
        },
      ],
