  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentBackspaceIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentBackspaceIcon-path-1',
            },
          ],
        },
      ],
