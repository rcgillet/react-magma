  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentFilterListIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentFilterListIcon-path-1',
            },
          ],
        },
      ],
