  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentMoveToInboxIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentMoveToInboxIcon-path-1',
            },
          ],
        },
      ],
