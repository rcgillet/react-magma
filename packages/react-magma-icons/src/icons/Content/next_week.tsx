  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentNextWeekIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentNextWeekIcon-path-1',
            },
          ],
        },
      ],
