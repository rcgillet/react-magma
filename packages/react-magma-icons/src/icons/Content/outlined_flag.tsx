  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentOutlinedFlagIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentOutlinedFlagIcon-path-1',
            },
          ],
        },
      ],
