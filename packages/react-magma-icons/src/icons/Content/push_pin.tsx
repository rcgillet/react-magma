  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentPushPinIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentPushPinIcon-path-1',
            },
          ],
        },
      ],
