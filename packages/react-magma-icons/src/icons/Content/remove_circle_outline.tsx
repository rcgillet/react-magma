  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentRemoveCircleOutlineIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentRemoveCircleOutlineIcon-path-1',
            },
          ],
        },
      ],
