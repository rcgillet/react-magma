  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ContentSortIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ContentSortIcon-path-1',
            },
          ],
        },
      ],
