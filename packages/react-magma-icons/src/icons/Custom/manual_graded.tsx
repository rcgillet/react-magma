  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'CustomManualGradedIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#CustomManualGradedIcon-path-1',
            },
          ],
        },
      ],
