  ...
  paths: [
    {
      ...
      id: 'DeviceAccessAlarmIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceAccessAlarmIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceAccessAlarmIcon-path-1',
            },
          ],
        },
      ],
...
export const DeviceAccessAlarmIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
