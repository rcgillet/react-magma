  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceAddAlarmIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceAddAlarmIcon-path-1',
            },
          ],
        },
      ],
