  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceAirplanemodeActiveIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceAirplanemodeActiveIcon-path-1',
            },
          ],
        },
      ],
...
export const DeviceAirplanemodeActiveIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
