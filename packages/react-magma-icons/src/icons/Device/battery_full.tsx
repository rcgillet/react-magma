  ...
  paths: [
    {
      ...
      id: 'DeviceBatteryFullIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceBatteryFullIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceBatteryFullIcon-path-1',
            },
          ],
        },
      ],
...
export const DeviceBatteryFullIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
