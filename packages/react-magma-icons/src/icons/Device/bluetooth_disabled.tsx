  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceBluetoothDisabledIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceBluetoothDisabledIcon-path-1',
            },
          ],
        },
      ],
