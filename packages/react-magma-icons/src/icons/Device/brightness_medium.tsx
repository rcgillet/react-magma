  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceBrightnessMediumIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceBrightnessMediumIcon-path-1',
            },
          ],
        },
      ],
