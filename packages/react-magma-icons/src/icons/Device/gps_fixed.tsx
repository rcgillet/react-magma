  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceGpsFixedIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceGpsFixedIcon-path-1',
            },
          ],
        },
      ],
...
export const DeviceGpsFixedIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
