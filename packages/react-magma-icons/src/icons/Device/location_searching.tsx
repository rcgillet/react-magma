  ...
  paths: [
    {
      ...
      id: 'DeviceLocationSearchingIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceLocationSearchingIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceLocationSearchingIcon-path-1',
            },
          ],
        },
      ],
...
export const DeviceLocationSearchingIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
