  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceSignalCellularOffIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceSignalCellularOffIcon-path-1',
            },
          ],
        },
      ],
