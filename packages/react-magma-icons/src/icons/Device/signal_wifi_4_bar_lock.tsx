  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceSignalWifi4BarLockIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceSignalWifi4BarLockIcon-path-1',
            },
          ],
        },
      ],
