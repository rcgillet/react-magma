  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceWidgetsIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceWidgetsIcon-path-1',
            },
          ],
        },
      ],
