  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'DeviceWifiLockIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#DeviceWifiLockIcon-path-1',
            },
          ],
        },
      ],
