  ...
  paths: [
    {
      ...
      id: 'EditorBubbleChartIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorBubbleChartIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorBubbleChartIcon-path-1',
            },
          ],
        },
      ],
...
export const EditorBubbleChartIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
