  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorFormatClearIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorFormatClearIcon-path-1',
            },
          ],
        },
      ],
