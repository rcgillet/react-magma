  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorFormatColorResetIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorFormatColorResetIcon-path-1',
            },
          ],
        },
      ],
