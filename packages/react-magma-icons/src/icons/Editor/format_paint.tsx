  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorFormatPaintIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorFormatPaintIcon-path-1',
            },
          ],
        },
      ],
