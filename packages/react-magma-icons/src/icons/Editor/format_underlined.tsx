  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorFormatUnderlinedIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorFormatUnderlinedIcon-path-1',
            },
          ],
        },
      ],
