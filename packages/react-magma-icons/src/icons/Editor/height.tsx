  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorHeightIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorHeightIcon-path-1',
            },
          ],
        },
      ],
