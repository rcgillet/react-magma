  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorNotesIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorNotesIcon-path-1',
            },
          ],
        },
      ],
