  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorScatterPlotIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorScatterPlotIcon-path-1',
            },
          ],
        },
      ],
...
export const EditorScatterPlotIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
