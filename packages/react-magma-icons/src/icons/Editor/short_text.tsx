  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorShortTextIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorShortTextIcon-path-1',
            },
          ],
        },
      ],
