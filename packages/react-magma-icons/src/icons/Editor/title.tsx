  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorTitleIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorTitleIcon-path-1',
            },
          ],
        },
      ],
