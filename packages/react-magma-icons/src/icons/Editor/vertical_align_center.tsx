  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorVerticalAlignCenterIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorVerticalAlignCenterIcon-path-1',
            },
          ],
        },
      ],
