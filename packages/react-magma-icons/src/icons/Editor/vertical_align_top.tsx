  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'EditorVerticalAlignTopIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#EditorVerticalAlignTopIcon-path-1',
            },
          ],
        },
      ],
