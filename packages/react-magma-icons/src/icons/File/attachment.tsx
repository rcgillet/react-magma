  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'FileAttachmentIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#FileAttachmentIcon-path-1',
            },
          ],
        },
      ],
