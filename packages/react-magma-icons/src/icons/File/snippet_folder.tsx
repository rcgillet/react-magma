  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'FileSnippetFolderIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#FileSnippetFolderIcon-path-1',
            },
          ],
        },
      ],
