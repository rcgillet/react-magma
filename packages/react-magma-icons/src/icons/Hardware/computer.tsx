  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'HardwareComputerIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#HardwareComputerIcon-path-1',
            },
          ],
        },
      ],
...
export const HardwareComputerIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
