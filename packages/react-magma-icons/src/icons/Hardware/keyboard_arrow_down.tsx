  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'HardwareKeyboardArrowDownIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#HardwareKeyboardArrowDownIcon-path-1',
            },
          ],
        },
      ],
