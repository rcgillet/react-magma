  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'HardwareKeyboardHideIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#HardwareKeyboardHideIcon-path-1',
            },
          ],
        },
      ],
