  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'HardwareLaptopMacIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#HardwareLaptopMacIcon-path-1',
            },
          ],
        },
      ],
