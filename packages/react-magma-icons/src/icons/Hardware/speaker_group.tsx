  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'HardwareSpeakerGroupIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#HardwareSpeakerGroupIcon-path-1',
            },
          ],
        },
      ],
