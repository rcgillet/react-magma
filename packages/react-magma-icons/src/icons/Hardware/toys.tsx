  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'HardwareToysIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#HardwareToysIcon-path-1',
            },
          ],
        },
      ],
