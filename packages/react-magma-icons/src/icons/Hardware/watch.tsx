  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'HardwareWatchIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#HardwareWatchIcon-path-1',
            },
          ],
        },
      ],
