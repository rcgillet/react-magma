  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageAudiotrackIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageAudiotrackIcon-path-1',
            },
          ],
        },
      ],
...
export const ImageAudiotrackIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
