  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageBrightness3Icon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageBrightness3Icon-path-1',
            },
          ],
        },
      ],
