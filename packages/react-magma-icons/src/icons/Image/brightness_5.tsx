  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageBrightness5Icon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageBrightness5Icon-path-1',
            },
          ],
        },
      ],
