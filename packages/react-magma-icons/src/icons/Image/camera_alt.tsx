  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageCameraAltIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageCameraAltIcon-path-1',
            },
          ],
        },
      ],
...
export const ImageCameraAltIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
