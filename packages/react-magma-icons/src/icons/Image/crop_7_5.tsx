  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageCrop75Icon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageCrop75Icon-path-1',
            },
          ],
        },
      ],
