  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageExposurePlus1Icon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageExposurePlus1Icon-path-1',
            },
          ],
        },
      ],
