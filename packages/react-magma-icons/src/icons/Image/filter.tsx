  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageFilterIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageFilterIcon-path-1',
            },
          ],
        },
      ],
...
export const ImageFilterIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
