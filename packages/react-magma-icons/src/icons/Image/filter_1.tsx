  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageFilter1Icon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageFilter1Icon-path-1',
            },
          ],
        },
      ],
...
export const ImageFilter1Icon: React.FunctionComponent<IconProps> = (
  props: IconProps
