  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageFilter5Icon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageFilter5Icon-path-1',
            },
          ],
        },
      ],
...
export const ImageFilter5Icon: React.FunctionComponent<IconProps> = (
  props: IconProps
