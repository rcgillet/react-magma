  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageFilterCenterFocusIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageFilterCenterFocusIcon-path-1',
            },
          ],
        },
      ],
...
export const ImageFilterCenterFocusIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
