  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageFlashAutoIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageFlashAutoIcon-path-1',
            },
          ],
        },
      ],
