  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageHdrStrongIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageHdrStrongIcon-path-1',
            },
          ],
        },
      ],
