  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageImageAspectRatioIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageImageAspectRatioIcon-path-1',
            },
          ],
        },
      ],
