  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageLooksTwoIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageLooksTwoIcon-path-1',
            },
          ],
        },
      ],
