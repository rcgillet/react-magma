  ...
  paths: [
    {
      ...
      id: 'ImageMovieCreationIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageMovieCreationIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageMovieCreationIcon-path-1',
            },
          ],
        },
      ],
...
export const ImageMovieCreationIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
