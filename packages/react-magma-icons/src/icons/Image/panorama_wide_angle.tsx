  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImagePanoramaWideAngleIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImagePanoramaWideAngleIcon-path-1',
            },
          ],
        },
      ],
