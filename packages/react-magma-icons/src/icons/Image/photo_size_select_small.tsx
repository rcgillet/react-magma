  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImagePhotoSizeSelectSmallIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImagePhotoSizeSelectSmallIcon-path-1',
            },
          ],
        },
      ],
