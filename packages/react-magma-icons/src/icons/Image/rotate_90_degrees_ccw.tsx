  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageRotate90DegreesCcwIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageRotate90DegreesCcwIcon-path-1',
            },
          ],
        },
      ],
