  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'ImageSlideshowIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#ImageSlideshowIcon-path-1',
            },
          ],
        },
      ],
