  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsAddLocationIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsAddLocationIcon-path-1',
            },
          ],
        },
      ],
