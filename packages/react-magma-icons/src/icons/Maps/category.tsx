  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsCategoryIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsCategoryIcon-path-1',
            },
          ],
        },
      ],
