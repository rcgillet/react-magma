  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsCleaningServicesIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsCleaningServicesIcon-path-1',
            },
          ],
        },
      ],
