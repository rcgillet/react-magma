  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsDirectionsBikeIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsDirectionsBikeIcon-path-1',
            },
          ],
        },
      ],
