  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsDirectionsBoatIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsDirectionsBoatIcon-path-1',
            },
          ],
        },
      ],
