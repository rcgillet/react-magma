  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsDirectionsSubwayIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsDirectionsSubwayIcon-path-1',
            },
          ],
        },
      ],
...
export const MapsDirectionsSubwayIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
