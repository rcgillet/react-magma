  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsEditLocationIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsEditLocationIcon-path-1',
            },
          ],
        },
      ],
