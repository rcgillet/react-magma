  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsElectricScooterIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsElectricScooterIcon-path-1',
            },
          ],
        },
      ],
