  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsLocalActivityIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsLocalActivityIcon-path-1',
            },
          ],
        },
      ],
...
export const MapsLocalActivityIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
