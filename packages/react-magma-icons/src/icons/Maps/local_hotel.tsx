  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsLocalHotelIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsLocalHotelIcon-path-1',
            },
          ],
        },
      ],
...
export const MapsLocalHotelIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
