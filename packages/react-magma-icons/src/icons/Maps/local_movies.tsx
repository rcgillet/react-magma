  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsLocalMoviesIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsLocalMoviesIcon-path-1',
            },
          ],
        },
      ],
...
export const MapsLocalMoviesIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
