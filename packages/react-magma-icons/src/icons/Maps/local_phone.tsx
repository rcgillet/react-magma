  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsLocalPhoneIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsLocalPhoneIcon-path-1',
            },
          ],
        },
      ],
...
export const MapsLocalPhoneIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
