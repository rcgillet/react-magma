  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsLocalPizzaIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsLocalPizzaIcon-path-1',
            },
          ],
        },
      ],
