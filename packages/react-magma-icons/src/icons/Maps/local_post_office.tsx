  ...
  paths: [
    {
      ...
      id: 'MapsLocalPostOfficeIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsLocalPostOfficeIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsLocalPostOfficeIcon-path-1',
            },
          ],
        },
      ],
...
export const MapsLocalPostOfficeIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
