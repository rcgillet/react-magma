  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsLocalShippingIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsLocalShippingIcon-path-1',
            },
          ],
        },
      ],
