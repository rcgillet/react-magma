  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsMedicalServicesIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsMedicalServicesIcon-path-1',
            },
          ],
        },
      ],
