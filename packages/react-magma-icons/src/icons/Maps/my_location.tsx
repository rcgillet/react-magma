  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsMyLocationIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsMyLocationIcon-path-1',
            },
          ],
        },
      ],
...
export const MapsMyLocationIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
