  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'MapsPersonPinCircleIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#MapsPersonPinCircleIcon-path-1',
            },
          ],
        },
      ],
