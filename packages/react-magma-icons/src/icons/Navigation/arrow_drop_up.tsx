  ...
  paths: [
    {
      ...
      id: 'NavigationArrowDropUpIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'NavigationArrowDropUpIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NavigationArrowDropUpIcon-path-1',
            },
          ],
        },
      ],
      uses: [
        {
          ...
          fill: '#000000',
          transform:
            'translate(12.000000, 12.250027) scale(1, -1) translate(-12.000000, -12.250027) ',
          xlinkHref: '#NavigationArrowDropUpIcon-path-1',
        },
      ],
    },
...
export const NavigationArrowDropUpIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
