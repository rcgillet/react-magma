  ...
  paths: [
    {
      ...
      id: 'NavigationArrowLeftIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'NavigationArrowLeftIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NavigationArrowLeftIcon-path-1',
            },
          ],
        },
      ],
...
export const NavigationArrowLeftIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
