  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NavigationMoreHorizIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NavigationMoreHorizIcon-path-1',
            },
          ],
        },
      ],
