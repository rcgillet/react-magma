  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NavigationNorthEastIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NavigationNorthEastIcon-path-1',
            },
          ],
        },
      ],
