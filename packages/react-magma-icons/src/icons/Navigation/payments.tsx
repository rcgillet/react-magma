  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NavigationPaymentsIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NavigationPaymentsIcon-path-1',
            },
          ],
        },
      ],
