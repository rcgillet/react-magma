  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsAccountTreeIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsAccountTreeIcon-path-1',
            },
          ],
        },
      ],
