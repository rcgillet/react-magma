  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsAirlineSeatFlatIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsAirlineSeatFlatIcon-path-1',
            },
          ],
        },
      ],
