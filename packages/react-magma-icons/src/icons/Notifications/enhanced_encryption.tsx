  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsEnhancedEncryptionIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsEnhancedEncryptionIcon-path-1',
            },
          ],
        },
      ],
