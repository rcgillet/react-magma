  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsEventNoteIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsEventNoteIcon-path-1',
            },
          ],
        },
      ],
