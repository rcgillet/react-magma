  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsPriorityHighIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsPriorityHighIcon-path-1',
            },
          ],
        },
      ],
