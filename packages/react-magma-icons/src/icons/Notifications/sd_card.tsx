  ...
  paths: [
    {
      ...
      id: 'NotificationsSdCardIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsSdCardIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsSdCardIcon-path-1',
            },
          ],
        },
      ],
...
export const NotificationsSdCardIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
