  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsSupportAgentIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsSupportAgentIcon-path-1',
            },
          ],
        },
      ],
