  ...
  paths: [
    {
      ...
      id: 'NotificationsTimeToLeaveIcon-path-1',
    },
  ],
  polygons: [],
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsTimeToLeaveIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsTimeToLeaveIcon-path-1',
            },
          ],
        },
      ],
...
export const NotificationsTimeToLeaveIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
