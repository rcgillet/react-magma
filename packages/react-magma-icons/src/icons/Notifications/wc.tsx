  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'NotificationsWcIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#NotificationsWcIcon-path-1',
            },
          ],
        },
      ],
