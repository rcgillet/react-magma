  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesBabyChangingStationIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesBabyChangingStationIcon-path-1',
            },
          ],
        },
      ],
