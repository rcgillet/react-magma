  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesFreeBreakfastIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesFreeBreakfastIcon-path-1',
            },
          ],
        },
      ],
