  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesNoCellIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesNoCellIcon-path-1',
            },
          ],
        },
      ],
