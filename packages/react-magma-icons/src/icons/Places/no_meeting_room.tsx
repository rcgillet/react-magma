  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesNoMeetingRoomIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesNoMeetingRoomIcon-path-1',
            },
          ],
        },
      ],
