  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesNoPhotographyIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesNoPhotographyIcon-path-1',
            },
          ],
        },
      ],
