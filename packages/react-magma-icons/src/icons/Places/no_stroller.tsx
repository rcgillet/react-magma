  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesNoStrollerIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesNoStrollerIcon-path-1',
            },
          ],
        },
      ],
