  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesRoomPreferencesIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesRoomPreferencesIcon-path-1',
            },
          ],
        },
      ],
