  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesRvHookupIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesRvHookupIcon-path-1',
            },
          ],
        },
      ],
