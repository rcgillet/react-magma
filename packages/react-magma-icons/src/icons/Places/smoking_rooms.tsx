  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesSmokingRoomsIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesSmokingRoomsIcon-path-1',
            },
          ],
        },
      ],
