  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'PlacesWheelchairPickupIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#PlacesWheelchairPickupIcon-path-1',
            },
          ],
        },
      ],
