  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialArchitectureIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialArchitectureIcon-path-1',
            },
          ],
        },
      ],
