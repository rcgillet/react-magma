  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialEmojiFoodBeverageIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialEmojiFoodBeverageIcon-path-1',
            },
          ],
        },
      ],
