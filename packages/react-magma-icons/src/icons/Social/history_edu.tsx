  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialHistoryEduIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialHistoryEduIcon-path-1',
            },
          ],
        },
      ],
