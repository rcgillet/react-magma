  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialLeaveBagsAtHomeIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialLeaveBagsAtHomeIcon-path-1',
            },
          ],
        },
      ],
