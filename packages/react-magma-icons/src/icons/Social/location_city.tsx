  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialLocationCityIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialLocationCityIcon-path-1',
            },
          ],
        },
      ],
