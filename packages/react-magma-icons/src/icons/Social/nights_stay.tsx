  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialNightsStayIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialNightsStayIcon-path-1',
            },
          ],
        },
      ],
