  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialNotificationsPausedIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialNotificationsPausedIcon-path-1',
            },
          ],
        },
      ],
