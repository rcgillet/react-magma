  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialPeopleIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialPeopleIcon-path-1',
            },
          ],
        },
      ],
...
export const SocialPeopleIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
