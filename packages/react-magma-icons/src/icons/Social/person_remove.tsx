  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialPersonRemoveIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialPersonRemoveIcon-path-1',
            },
          ],
        },
      ],
...
export const SocialPersonRemoveIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
