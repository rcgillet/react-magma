  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialSelfImprovementIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialSelfImprovementIcon-path-1',
            },
          ],
        },
      ],
