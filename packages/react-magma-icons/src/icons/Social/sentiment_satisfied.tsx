  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialSentimentSatisfiedIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialSentimentSatisfiedIcon-path-1',
            },
          ],
        },
      ],
...
export const SocialSentimentSatisfiedIcon: React.FunctionComponent<IconProps> = (
  props: IconProps
