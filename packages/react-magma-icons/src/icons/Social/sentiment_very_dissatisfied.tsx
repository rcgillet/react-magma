  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialSentimentVeryDissatisfiedIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialSentimentVeryDissatisfiedIcon-path-1',
            },
          ],
        },
      ],
