  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialSportsBaseballIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialSportsBaseballIcon-path-1',
            },
          ],
        },
      ],
