  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialSportsFootballIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialSportsFootballIcon-path-1',
            },
          ],
        },
      ],
