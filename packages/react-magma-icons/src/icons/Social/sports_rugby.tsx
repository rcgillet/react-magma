  ...
  groups: [
    {
      ...
      masks: [
        {
          id: 'SocialSportsRugbyIcon-mask-2',
          fill: 'white',
          uses: [
            {
              xlinkHref: '#SocialSportsRugbyIcon-path-1',
            },
          ],
        },
      ],
